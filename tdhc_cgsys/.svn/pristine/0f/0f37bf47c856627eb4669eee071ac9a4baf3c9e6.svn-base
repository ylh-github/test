 ...
 *
 */
public class CG_H004_C001 implements Serializable{	
    /**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private String cItemdes;
  ...
  public void setcSubitemid ( String cSubitemid) {
	...
	private String cBeforearrex;
	public  String getcBeforearrex() {
	return cBeforearrex;
	}
  public void setcBeforearrex ( String cBeforearrex) {
    this.cBeforearrex = cBeforearrex ;
	}
}