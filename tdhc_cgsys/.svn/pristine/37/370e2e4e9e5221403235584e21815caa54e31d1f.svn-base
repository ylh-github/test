...
public class TpCgcontractmtt {
    ...
    private int cCsubmitnum;
    
    private String cXxkrecaller;
    private Date cRecalltime;
    private String cRecallstate;
    private int cRecallnum;
    
    private String cDelivery;
    private String cDeliveryday;
    private Date cDeliverytime;
    //变更合同号
    private String cConnumalter;
    //合同名称
    private String cConnumname;
    //method
    
    private String cQid;
    private String cTrinvoice;
    private String cQconnum;
    private String cUnitspec;
	...
	public String getcTrinvoice() {
		return cTrinvoice;
	}

	public void setcTrinvoice(String cTrinvoice) {
		this.cTrinvoice = cTrinvoice;
	}

	public String getcQconnum() {
		return cQconnum;
	}

	public void setcQconnum(String cQconnum) {
		this.cQconnum = cQconnum;
	}
    ...
    public void setcCheckway(String cCheckway) {
        this.cCheckway = cCheckway == null ? null : cCheckway.trim();
    }
    ...
    public void setcTransway(String cTransway) {
        this.cTransway = cTransway == null ? null : cTransway.trim();
    }
    ...
    public void setcSignstep(String cSignstep) {
        this.cSignstep = cSignstep == null ? null : cSignstep.trim();
    }
    ...
    public void setcConline(String cConline) {
        this.cConline = cConline == null ? null : cConline.trim();
    }
    ...
    public void setcOrmtid(String cOrmtid) {
        this.cOrmtid = cOrmtid == null ? null : cOrmtid.trim();
    }
    ...
    public void setcOrstid(String cOrstid) {
        this.cOrstid = cOrstid == null ? null : cOrstid.trim();
    }
    ...
    public String getcSuppcode() {
        return cSuppcode;
    }

    public void setcSuppcode(String cSuppcode) {
        this.cSuppcode = cSuppcode == null ? null : cSuppcode.trim();
    }
	...
	public int getcCsubmitnum() {
		return cCsubmitnum;
	}
	public void setcCsubmitnum(int cCsubmitnum) {
		this.cCsubmitnum = cCsubmitnum;
	}
	...
	public int getcRecallnum() {
		return cRecallnum;
	}

	public void setcRecallnum(int cRecallnum) {
		this.cRecallnum = cRecallnum;
	}
	...
	public void setcDeliveryday(String cDeliveryday) {
		this.cDeliveryday = cDeliveryday;
	}
	...
	public String getcConnumalter() {
		return cConnumalter;
	}

	public void setcConnumalter(String cConnumalter) {
		this.cConnumalter = cConnumalter;
	}

	public String getcConnumname() {
		return cConnumname;
	}

	public void setcConnumname(String cConnumname) {
		this.cConnumname = cConnumname;
	}
