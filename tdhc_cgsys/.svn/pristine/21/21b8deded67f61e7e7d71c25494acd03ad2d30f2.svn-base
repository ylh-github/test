...
public class TpCgcontrast implements java.io.Serializable{
    private String cId;

    private String cConnum;

    private String cArrivalnum;

    private String cFinalarrnum;
    ...
    public String getcArrivalnum() {
        return cArrivalnum;
    }

    public void setcArrivalnum(String cArrivalnum) {
        this.cArrivalnum = cArrivalnum == null ? null : cArrivalnum.trim();
    }

    public String getcFinalarrnum() {
        return cFinalarrnum;
    }

    public void setcFinalarrnum(String cFinalarrnum) {
        this.cFinalarrnum = cFinalarrnum == null ? null : cFinalarrnum.trim();
    }
