...
let wanchengzhuangtai = [
    /*
	 * { value: '0', description: '未完成' }, { value: '1', description: '已完成' }
	 */

]
let shifoujixu = [
   /*
	 * { value: '0', description: '否' }, { value: '1', description: '是' }
	 */

]
let shenhezhuangtai = [
    /*
	 * { value: '1', description: '未审核' }, { value: '2', description: '已通过' }, {
	 * value: '3', description: '未通过' }
	 */
]
let tijiaozhuangtai = [
    /*
	 * { value: '0', description: '未提交' }, { value: '1', description: '已提交' }
	 */

]
let caigoubumen = [
    /*
	 * { value: '0', description: '采购一组' }, { value: '1', description: '采购二组' }, {
	 * value: '2', description: '采购三组' },
	 */
]
let caigouyuan = [
   /*
	 * { value: '0', description: 'CG01' }, { value: '1', description: 'CG02' }, {
	 * value: '2', description: 'CG03' },
	 */
]
let caigoujindu = [
    /*
	 * { value: '0', description: '未开始采购' }, { value: '1', description: '任务已接收' }, {
	 * value: '2', description: '寻找供应商' }, { value: '3', description: '询价\ 比价' }, {
	 * value: '4', description: '订货' }, { value: '5', description: '发货' }, {
	 * value: '6', description: '到货' }, { value: '7', description: '入库' }, {
	 * value: '8', description: '完成' }, { value: '9', description: '取消转国内' },
	 */

]
let fenpeizhuangtai = [
   /*
	 * { value: '1', description: '已分配' }, { value: '0', description: '未分配' },
	 */

]
let caigouzhuangtai = [
   /*
	 * { value: '0', description: '未采购' }, { value: '1', description: '已采购' },
	 */

]
let wuzileixing = [
   /*
	 * { value: '1', description: '设备' }, { value: '2', description: '备件' },
	 */

]
let shenqingbumen = [
   /*
	 * { value: '1', description: '采购部' }, { value: '2', description: '销售部' }, {
	 * value: '3', description: '人事部' }, { value: '4', description: '财务部' }, {
	 * value: '5', description: '生产部' },
	 */
]
...
//            },
    ...
    // cgC002M1s1:{
		...
		// msg.data.cgC002M1s1 = searchdataFormM1.option('formData');
  // //开始时间
		// let startTime =msg.data.cgC002M1s1.startTime;
		// msg.data.cgC002M1s1.startTime = new Date(startTime.getFullYear(),
		// startTime.getMonth(), startTime.getDate(), 0, 0, 0, 0);

		// // 结束时间
		// let endTime = msg.data.cgC002M1s1.endTime;
		// msg.data.cgC002M1s1.endTime = new Date(endTime.getFullYear(),
		// endTime.getMonth(), endTime.getDate(), 23, 59, 59, 999);
  ...
  // //console.log.log(msg)
        ...
        msg.data.cgC002M1s1 = [searchdataFormM1.option('formData')];
        $.ajax({
            url: Cake.Piper.getAuthUrl('../../tdhc_cgsys/CG_C002/M1S11Q'),
            dataType: 'json', // 返回格式为json
            async: true, // 请求是否异步,默认为异步,这也是ajax重要特性
    ...
    function M1S21_serDel() {
        ...
        let rowData = grid.getSelectedRowsData()
...
// -------------------------------------------zsq
    ...
    // };
    // msg.data.cgC003S1s2 =
	// $('#dataGridS1').dxDataGrid('instance').getSelectedRowsData();
    // cake.Ui.LoadPanel.show()
    // $.ajax({
    // url:
	// Cake.Piper.getAuthUrl('../../tdhc_cgsys/CG_C003/S1S21Q'),
    // dataType: 'json', //返回格式为json
    // async: true, //请求是否异步，默认为异步，这也是ajax重要特性
    // data: JSON.stringify(msg), //下拉框的参数值 queryCondition 上面有定义 cStlCla
	// 后台给的固定的名
    ...
    // if (data.data == null) {
    // $('#dataGridS2').dxDataGrid('instance').option('dataSource', null)
    // return
    // }
    // let select;
