...
public class TpCgorderstController {
	...
	//选择需要预登记的项目---不加用户
	@RequestMapping(value="/before_serDel2",method=RequestMethod.POST) 
	@ResponseBody 
	public  ResponseObject<EmptyTag, List<TpCgordermt>> before_serDel2(@RequestParamUser User user,@RequestBody RequestObject<EmptyTag, YDJ_Req> requestObject){ 
		return orstService.before_serDel2(user,requestObject);
	} 
