 ...
 * @return
 */
ResponseObject<EmptyTag, EmptyData> M1S21HB(User user, CG_XXLY_Request_M1S1 data, String session);
/**
 * 撤销合并
 * @param user
 * @param data
 ...
 * @return
 */
ResponseObject<EmptyTag, EmptyData> M1S21CX(User user, CG_XXLY_Request_M1S1 data, String session);
/**
 * 维护页面标记筛选
 * @param emptyData
 * @param session
 * @return
 */
ResponseObject<EmptyTag, CG_XXLY_Response_M1S1> searchBjInfo(EmptyData emptyData, String session);
/**
 * 信息卡维护页面的标记处理
 * @param user
 * @param data
 ...
 * @return
 */
ResponseObject<EmptyTag, EmptyData> deleteBj(User user, CG_XXLY_Request_M1S1 data, String session);
 }