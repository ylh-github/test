		...
		},
		{
			...
			options: {
				...
				onClick: function () {
					...
					$('#contract_type14').dxForm('instance').getEditor('cbgfs').option('value', changeMode[0].cSubitemid)
					shangbiao()
		...
		},
		{
			...
			options: {
				...
				onClick: function () {
					...
					$('#contract_type14').dxForm('instance').getEditor('cbgfs').option('value', rowsData.cbgfs);
	...
	function Update_moniU() {
		...
		$('#submit').dxButton({
			...
			onClick: function (e) {
				...
				msg.data.contractmtt.cCludetime = moment($('#span1').text()).valueOf()
				msg.data.contractmtt.cConnum = $('#span2').val();
				msg.data.contractmtt.cConnums = $('#span3').val()
				msg.data.contractmtt.cConmoney = $('#span4').val()
				msg.data.contractmtt.cTrinvoice = $('#span5').val()

				// 原合同
				msg.data.tpCgcontractmtt = $('#contract').dxForm('instance').option('formData');

				// 变更后
				msg.data.tpCgcontractmtt = $('#changeTo').dxForm('instance').option('formData');
				console.log(JSON.stringify(msg))
		...
		$('#submit1').dxButton({
			...
			onClick: function (e) {
				...
				// 原合同
				msg.data.tpCgcontractmtt = $('#contractCont').dxForm('instance').option('formData');

				// 变更后
				msg.data.tpCgcontractmtt = $('#changeToCont').dxForm('instance').option('formData');
