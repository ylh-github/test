...
public class TpCgcontractstt {
    ...
    public void setcMtid(String cMtid) {
        this.cMtid = cMtid == null ? null : cMtid.trim();
    }
    ...
    public void setcGoodsnum(String cGoodsnum) {
        this.cGoodsnum = cGoodsnum == null ? null : cGoodsnum.trim();
    }
    ...
    public void setcGoodscase(String cGoodscase) {
        this.cGoodscase = cGoodscase == null ? null : cGoodscase.trim();
    }
    ...
    public void setcSumprice(String cSumprice) {
        this.cSumprice = cSumprice == null ? null : cSumprice.trim();
    }
    ...
    public void setcArrgoodsex(String cArrgoodsex) {
        this.cArrgoodsex = cArrgoodsex == null ? null : cArrgoodsex.trim();
    }
    ...
    public void setcArrgoodstime(String cArrgoodstime) {
        this.cArrgoodstime = cArrgoodstime == null ? null : cArrgoodstime.trim();
    }
    ...
    public void setcGroudtotalnum(String cGroudtotalnum) {
        this.cGroudtotalnum = cGroudtotalnum == null ? null : cGroudtotalnum.trim();
    }
    ...
    public void setcResiduenum(String cResiduenum) {
        this.cResiduenum = cResiduenum == null ? null : cResiduenum.trim();
    }
    ...
    public void setcArrallyorn(String cArrallyorn) {
        this.cArrallyorn = cArrallyorn == null ? null : cArrallyorn.trim();
    }
    ...
    public void setcCheckyorn(String cCheckyorn) {
        this.cCheckyorn = cCheckyorn == null ? null : cCheckyorn.trim();
    }
    ...
    public void setcQuadealline(String cQuadealline) {
        this.cQuadealline = cQuadealline == null ? null : cQuadealline.trim();
    }
...
public String getcChaconnum() {
	return cChaconnum;
}

public void setcChaconnum(String cChaconnum) {
	this.cChaconnum = cChaconnum;
}
