...
public class TpChorderst {
    ...
    public void setcMustneed(String cMustneed) {
        this.cMustneed = cMustneed == null ? null : cMustneed.trim();
    }
    ...
    public void setcArrtime(String cArrtime) {
        this.cArrtime = cArrtime == null ? null : cArrtime.trim();
    }
    ...
    public void setcDeptor(String cDeptor) {
        this.cDeptor = cDeptor == null ? null : cDeptor.trim();
    }
    ...
    public void setcManor(String cManor) {
        this.cManor = cManor == null ? null : cManor.trim();
    }
    ...
    public void setcAllotstate(String cAllotstate) {
        this.cAllotstate = cAllotstate == null ? null : cAllotstate.trim();
    }
    ...
    public void setcAllotman(String cAllotman) {
        this.cAllotman = cAllotman == null ? null : cAllotman.trim();
    }
    ...
    public void setcPlanor(String cPlanor) {
        this.cPlanor = cPlanor == null ? null : cPlanor.trim();
    }
    ...
    public void setcPolinormtime(String cPolinormtime) {
        this.cPolinormtime = cPolinormtime == null ? null : cPolinormtime.trim();
    }
