...
public class TpConrevocare implements java.io.Serializable{
    /**
	 * @author lhb
	 * @date 2020年1月9日下午2:01:26
	 */
    ...
    private String cYnstorage;

    private String cYnpayment;
	...
	public String getcYnstorage() {
        return cYnstorage;
    }

    public void setcYnstorage(String cYnstorage) {
        this.cYnstorage = cYnstorage == null ? null : cYnstorage.trim();
    }

    public String getcYnpayment() {
        return cYnpayment;
    }

    public void setcYnpayment(String cYnpayment) {
        this.cYnpayment = cYnpayment == null ? null : cYnpayment.trim();
    }
