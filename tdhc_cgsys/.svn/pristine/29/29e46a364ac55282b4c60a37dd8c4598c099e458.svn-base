    ...
    function start1() {
        ...
        $.ajax({
            ...
            success: function (data) {
                // //console(data.data.tpCgordermtSum)
 ...
 //                    readOnly:true,
    ...
    function M1S33_serDel() {
        ...
        option3 = {
            ...
            //     color: function (params) {
            //         //  var colorList = ['#16A085', '#4A235A', '#C39BD3 ', '#C33531', '#EFE42A', '#64BD3D', '#F9E79F', '#BA4A00', '#ECF0F1', '#616A6B', '#EAF2F8', '#4A235A', '#3498DB'];
            //         // var colorList = ['#6672f3','#6de6da'];

            //         var colorList = ['#6672f3', '#6de6da', '#6672f3', '#6de6da',  '#6672f3', '#6de6da', '#6672f3', '#6de6da', '#6672f3', '#6de6da', '#6672f3', '#6de6da'];
            //         return colorList[params.dataIndex]
            //     }
            // },
            series: [{
