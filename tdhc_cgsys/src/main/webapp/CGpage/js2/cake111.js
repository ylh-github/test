...
(function (Cake) {
    ...
    (function (Ui) {
        ...
        class LoadPanel {
             ...
             */
            static close() {
                const staticLoadPanel = this.$staticLoadPanel;
                this.$staticLoadPanel = null;
                return this.dispose(staticLoadPanel);
            }
        }
        /**
         *
...
(function (Cake) {
    ...
    (function (Piper) {
		 function getAuthUrl(url) {
	    	var  token = getWindowHref("accessToken");
