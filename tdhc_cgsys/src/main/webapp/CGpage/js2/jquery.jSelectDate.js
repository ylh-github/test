 ...
 */
    init: function (els, isDisabled) {
         ...
         */
            ...
            var cKqstoptimeHrYnygkq = $("#attendance").dxForm('instance').getEditor('cKqstoptimeHrYnygkq').option('value')
            var newMounth = moment(cKqstoptimeHrYnygkq).format('MM')

            // if(newMounth == 'Invalid date'){
            //     newMounth = 12
            // }
