...
let USER = [];
let url = Cake.Piper.getAuthUrl('../../tdhc_cgsys/CG_q002mt/selectQ001_7');
let S1S21addIns;
let C0041addIns;
let M1S13addIns;
let C00B1addIns;
...
//            }
    ...
    searchdataFormM1.getEditor('startTime').option('value','2019-01-01');   
...
//            },
            ...
            {
                dataField: 'cCreatetime2',
                caption: '拟合同创建时间',
                dataType: "date",
                 width: 90,
                // alignment: 'center',
                format: "yyyy-MM-dd hh:dd:mm"
            },
