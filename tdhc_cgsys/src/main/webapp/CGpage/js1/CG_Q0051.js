...
//                        width: 200,
         ...
         $('#packing').dxForm({
             ...
             items: [{
                     ...
                     editorOptions: {
                         showClearButton: true,
                         value: '第二大条款小条款1.供方包装、装运标记应符合国家或专业标准保护措施，应适应于远距离国际运输、防潮、防震、防锈和防粗暴装卸、确保货物安全无损运抵现场，包装物由供方提供，使用完毕后不回收。（双方约定供方不得使用未熏蒸实木；供方如有违约，按2000元/件支付违约金给需方）'
                     },
                 },
                 {
                     dataField: 'cSw04',
                     ...
                     editorOptions: {
                         ...
                         showClearButton: true,
                         value: "第二大条款小条款2.备品备件及专业工具应分别包装，并在包装箱外用英文加以注明，一次性发货。"
                     },
                 },
             ]
         }).dxForm('instance');
