...
//            			};
//            			
//            			let msgdate = $('#dataGridS2').dxDataGrid('instance').getSelectedRowsData()[0];
//            			let cConnum = msgdate.cConnum;
//            			console.log(msgdate.cConnum)
//            			let url = "http://10.107.3.254:8899/WebReport/ReportServer?reportlet=Contact_3.cpt&cConnum="+ cConnum;
...
//                         valueExpr: 'cItemidTbCgclausedata',
//                         displayExpr: 'cItemdesTbCgclausedata',
//                         searchEnabled: true,
//                         showClearButton: true,
//                         width: 200,
//                         placeholder: '请选择',
...
//                                    console.log(8888888);
                                    ...
                                    //签订地址
                                    $('#addForm2').dxForm('instance').getEditor('cCludeaddr').option('value', data.data[0].cSw01);
...
//                editorOptions: {
//                    showClearButton: true,
//                    value: '双方约定。（按实际过磅、化验结果结算的注明计算方式）',
//
//                },
//            }, ]
//        }).dxForm('instance');
...
//                        editorOptions: {
//                            showClearButton: true,
//                            value: '应符合该产品的合同约定条件；合同未约定的，按行业标准要求执行；无行业标准的，按国家标准要求执行；需方对产品有特殊要求的按要求执行。'
//                        },
//                    }, {
//                        dataField: 'cSw02',
//                        label: {
...
//                        editorOptions: {
//                            showClearButton: true,
//                            value: '产品保质期为壹年。供方承诺产品自交货之日起（一年）内能在正常条件下使用，如出现问题，由供方负责国内免费保修。供方承诺保证原厂正品，如有假冒伪劣，假一赔十。'
//                        },
//                    }, ]
//                },
                // {
                //     dataField: '',
                //     label: {
                //         text: '3.供方保证基于本合同提供的产品或者服务，需方使用、制造、销售、出口等经营性活动不会侵犯任何第三方的知识产权；若发生上述情况，供方保证承担由此产生的法律责任；同时由于供方产品发生知识产权争议或纠纷对需方造成经济损失的，需方有权随时向供方提出赔偿要求。'
                //     },
                //     editorOptions: {
                //         showClearButton: true,
                //         visible: false
...
//        }).dxForm('instance');
        ...
        //     width: '100%',
        //     height: 30,
        //     placeholder: '1.供方包装、装运标记应符合国家或专业标准保护措施，应适应于远距离国际运输、防潮、防震、防锈和防粗暴装卸、确保货物安全无损运抵现场，包装物由供方提供，使用完毕后不回收。（双方约定供方不得使用未熏蒸实木；供方如有违约，按2000元/件支付违约金给需方）',
        //     value: "1.供方包装、装运标记应符合国家或专业标准保护措施，应适应于远距离国际运输、防潮、防震、防锈和防粗暴装卸、确保货物安全无损运抵现场，包装物由供方提供，使用完毕后不回收。（双方约定供方不得使用未熏蒸实木；供方如有违约，按2000元/件支付违约金给需方）",
        //     // showClearButton:true
        // })
        ...
        //     width: '100%',
        //     height: 30,
        //     placeholder: '2.备品备件及专业工具应分别包装，并在包装箱外用英文加以注明，一次性发货。',
        //     value: "2.备品备件及专业工具应分别包装，并在包装箱外用英文加以注明，一次性发货。",
        //     // showClearButton:true
        // })
