...
//let urlll = '../../tdhc_cgsys/CG_q002mt/selectQ001_71?'+url[0]+'='+url[1];
let S1S21addIns;
let C0041addIns;
let M1S13addIns;
let C00B1addIns;
...
//            }
    ...
    console.log(url)
    let uken1 = decodeURIComponent(localStorage.getItem("uoken1"))  // 拿出到缓存
    param = uken1.split(',')
    param1 = param[param.length-1] 
//    console.log(uken1)
//    console.log(param)
//    console.log(param1)
    if(param1=='benz'){
...
//            console.log(JSON.stringify(msg))
                $.ajax({
                    url: '../../tdhc_cgsys/CG_q002mt/selectQ001_71?'+url[0]+'='+url[1],
                    dataType: 'json', //返回格式为json   
                    async: true, //请求是否异步,默认为异步,这也是ajax重要特性          
                    data: JSON.stringify(msg), //下拉框的参数值  queryCondition 上面有定义 cStlCla 后台给的固定的名         
                    type: 'post', //请求方式 get 或者post ,         
...
//       console.log(uken1)
//       console.log(param)
       var startTime = new Date(param[2])
       console.log(startTime)
       var endTime = new Date(param[3])
       console.log(endTime)
           msg = {
               ver: '53cc62f6122a436083ec083eed1dc03d',
               session: '42f5c0d7178148938f4fda29460b815a',
           ...
           console.log(JSON.stringify(msg))
               $.ajax({
                   url: '../../tdhc_cgsys/CG_q002mt/selectJutXM?'+url[0]+'='+url[1],
                   dataType: 'json', //返回格式为json   
                   async: true, //请求是否异步,默认为异步,这也是ajax重要特性          
                   data: JSON.stringify(msg), //下拉框的参数值  queryCondition 上面有定义 cStlCla 后台给的固定的名         
                   type: 'post', //请求方式 get 或者post ,         
