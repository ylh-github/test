			...
			options: {
				...
				onClick: function () {
					 ...
					 $('#addmotai3').show()
						...
						addIns.option('title', '信息卡2')
						addIns.show();
					 let gridLen = addmonigrid.length;
					  if (gridLen <= 1) {
		                    //console.log('0或1')
	        ...
	        if(msg.data.tpCgcontractmt.length==0){
	        	...
	        	$.ajax({
	                ...
	                success: function(data) {
	                	...
	                	addmonigrid = data.data.cgXXK_Request;//数组
...
//			},
//			onToolbarPreparing: function (e) {
//				operateFormS4buts.forEach(item => e.toolbarOptions.items.push(item));
//
//			},
//			onEditingStart: function (e) { },
//			columns: [
