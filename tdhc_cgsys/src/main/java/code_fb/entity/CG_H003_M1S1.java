 ...
 *
 */
public class CG_H003_M1S1 implements Serializable{	
    /**
	 * 
	 */
  ...
  public void setcConnum ( String cConnum) {
	...
	private String cForoutland;
	public  String getcForoutland() {
	return cForoutland;
	}
  public void setcForoutland ( String cForoutland) {
  ...
  public void setcModifier ( String cModifier) {
	...
	private String cForinland;
	public  String getcForinland() {
	return cForinland;
	}
  public void setcForinland ( String cForinland) {
