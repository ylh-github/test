 ...
 *
 */
public class CG_A004_C003 implements Serializable{	
    /**
	 * 
	 */
  ...
  public void setcItemdes ( String cItemdes) {
	...
	private String cEdudeg;
	public  String getcEdudeg() {
	return cEdudeg;
	}
  public void setcEdudeg ( String cEdudeg) {
    this.cEdudeg = cEdudeg ;
	}
