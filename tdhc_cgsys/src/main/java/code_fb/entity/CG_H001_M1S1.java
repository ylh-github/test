 ...
 *
 */
public class CG_H001_M1S1 implements Serializable{	
    /**
	 * 
	 */
...
public String getcSeconnum() {
	return cSeconnum;
}
public void setcSeconnum(String cSeconnum) {
	this.cSeconnum = cSeconnum;
}
