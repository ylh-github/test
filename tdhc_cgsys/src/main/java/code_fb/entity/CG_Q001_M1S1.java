 ...
 *
 */
public class CG_Q001_M1S1 implements Serializable {
	/**
	 * 
	 */
	...
	public void setcTimeapply(String cTimeapply) {
		if (cTimeapply.length() == 9) {
			this.cTimeapply = cTimeapply.substring(0, 9);
		} else if (cTimeapply.length() == 10) {
			this.cTimeapply = cTimeapply.substring(0, 10);
		} else {
