...
import code_fb_cg.request.ItemRequestObject; 
 ...
 //根据请购单号查询合同
 List<CG_H001_M1S1> M1S11QCG_H001_M1S1BycOrdernum( @Param("h002request")H002request h002request);
 ...
 List<CG_H001_M1S1> M1S11QBJ( @Param("h002request")H002request h002request);
 List<CG_H001_M1S1> selectByconnum(@Param("cConnum")String cConnum);
...
List<CG_H001_M1S1> selectHtInfo(ItemRequestObject itemRequestObject);
 }