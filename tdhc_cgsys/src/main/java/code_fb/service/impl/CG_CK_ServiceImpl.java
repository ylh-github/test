...
//			}
	...
	@Override
	public ResponseObject<EmptyTag, CG_CK_Response_M1S1> derivedData(User user, CG_CK_Request_M1S1 cgCkRequestM1s1,
			String session) {
		ResponseObjectBuilder builder = ResponseObjectBuilder.create();
		CG_CK_Response_M1S1 data = new CG_CK_Response_M1S1();
		data.setCgCkM1s1(frcDao.selectByCreatetime(cgCkRequestM1s1.getStartTime(),cgCkRequestM1s1.getEndTime()));
