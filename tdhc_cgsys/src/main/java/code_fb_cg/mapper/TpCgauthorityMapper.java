...
public interface TpCgauthorityMapper {
	...
	List<TpCgauthority> selectSubitemidAll(@Param("cSubitemid")String[] cSubitemid, @Param("cItemid")String cItemid);
	
	List<TpCgauthority> selectSubitemidAll2(@Param("cSubitemid")String[] cSubitemid, @Param("cItemid")String cItemid);
}