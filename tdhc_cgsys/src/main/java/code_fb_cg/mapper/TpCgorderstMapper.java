...
public interface TpCgorderstMapper {
	...
	List<Q001M1s1Qrequest> selectQ001_71(MtRequest mtRequest);
	...
	//请购单项目与合同号不一样的
	List<TpCgorderst> searchTpCgorderstTJ(@Param("hompageObject") TpCgordermtM1S13 data);
	//统计总请购项，已采购项，未采购项，采购总金额
	ItemReport selectItem(@Param("cDepartment")String cDepartment, @Param("startTime") Date startTime, @Param("endTime") Date endTime);
	//具体页面的查询
	List<Q001M1s1Qrequest> selectJutXM(ItemRequestObject itemRequestObject);
