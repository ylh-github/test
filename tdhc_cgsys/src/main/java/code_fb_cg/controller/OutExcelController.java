...
import code_fb_cg.entity.OutExcelFile;
...
public class OutExcelController {
	...
	public  void outExcelmt(@RequestBody OutExcel requestObject, HttpServletResponse response){
		ResponseObjectBuilder builder = ResponseObjectBuilder.create();
		//获取文件名称
		OutExcelFile outFile = new OutExcelFile();
		for (OutExcelFile outExcelResponse : requestObject.getOutExcelFile()) {
		...
		//Excel表格
		//表头
		String[] columnName = { "公司名称", "单据编号", "申请部门", "申请人", "收单日期", "物资名称", "物资类型", "是否急需", "规格型号", "单位", "申报量", "要求到货时间","采购状态","用途说明",
				"申请人联系方式","采购期限","采购部门","采购员","采购员联系方式","分配人","采购进度","采购进度时间"};
		...
		//数据
		String[][] dataList = ordermtService.outExcelmt(requestObject); 
		//Excel方法
		 try {
