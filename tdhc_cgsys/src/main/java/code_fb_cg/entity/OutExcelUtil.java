...
public class OutExcelUtil {
	...
	public boolean ExportNoResponse(String sheetName, String titleName, String fileName, int columnNumber,
		...
		if (columnNumber == columnWidth.length&& columnWidth.length == columnName.length) {
			...
			// 第六步，将文件存到指定位置
			try {
				FileOutputStream fout = new FileOutputStream(""+fileName+".xls");//D:\新建文件夹
				wb.write(fout);
//				String str = "导出" + fileName + "成功！";
//				System.out.println(str);
